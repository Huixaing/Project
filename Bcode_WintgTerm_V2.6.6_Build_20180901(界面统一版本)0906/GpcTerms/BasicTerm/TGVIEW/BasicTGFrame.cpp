...
int CBasicTgFrame::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
		...
		AddButtonToBar(12,"股道批量编辑",ID_TRAINPLAN_SIDE_YINGYE_EDIT,0,FALSE);
		AddButtonToBar(13,"开始画线",ID_INSERT_NEW_TRAIN,0,FALSE);
		AddButtonToBar(14,"结束画线",ID_DRAW_NEW_TRAIN_END,0,FALSE);
	
		AddButtonToBar(15,"",ID_DDML_MANAGE,0,FALSE);
		return 0;
}
