...
// BY CUIHU
#define GET_ITEM_STRING_X(id, func) \
				case id: \
					func(id,static_cast<CPropertyItemString*>(pPropertyItem)->GetData()); \
					break;

#define GET_ITEM_LIST_X(id, func) \
				case id: \
{ int tmp; static_cast<CPropertyItemList*>(pPropertyItem)->GetData(tmp); func(id,tmp);}\
					break;
/////////////////////////////////////////////////////////////////////////////
