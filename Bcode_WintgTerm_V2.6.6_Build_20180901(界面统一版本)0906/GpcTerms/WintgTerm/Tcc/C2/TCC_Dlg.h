...
#define ID_CANCEL_LIMITSPEED	(WM_USER + 501)
#define ID_SEND_LIMITSPEED	(WM_USER + 502)
#define ID_DEL_LIMITSPEED	(WM_USER + 503)
#define ID_DEL_TCCCOMMAND   (WM_USER + 504)
#define ID_DEL_STOCKCOMMAND (WM_USER + 505)
#define ID_INIT_STCC_LINE	(WM_USER + 506)
#define ID_INIT_STCC_LINE2	(WM_USER + 507)

class CStccLineStatusGrid : public CGridCtrl {
	DECLARE_DYNAMIC(CStccLineStatusGrid)

public:
	CStccLineStatusGrid();
	virtual ~CStccLineStatusGrid();
...
public:
	...
	void SelectStation(stano_t nStaID);
	void SetStatus(stano_t nStaID, lineid_t nTccLineID[], dir_t dir[], INT num);
	void ClearStatus();
...
private:
	...
	afx_msg void OnInitStccLine();
	afx_msg void OnInitStccLine2();
	//}}AFX_MSG
...
public:
	...
	afx_msg void OnBnClickedTccDelcmdBtn();
...
public:
	...
	void Refresh();
	void SetTccLineInitialCommandOperResult(
			stano_t nTccID, 
			lineid_t nTccLineID, 
			dir_t dir,
			DWORD nStatus,
...
private:
	...
	CStccLineStatusGrid m_StccLineStatusGrid;
