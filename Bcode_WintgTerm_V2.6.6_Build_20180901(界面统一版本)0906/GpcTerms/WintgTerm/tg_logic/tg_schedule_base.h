...
struct CMMIOperFlag{
	enum
	{
		...
		JIE_JIAOLUT_RELATION= 0x00040000,
	};
...
public:
	...
	bool   IfTrainTimeLessTime(TIME ntime) const;
	bool   IfTrainInTimeScope(TIME stime, TIME etime) const;
...
////////////////////////SET///////////////////////////////////////////////////
	...
	bool  IsSamePathway(const CTG_SingleTrain& train) const; // 比较两列车径路是否相同
};
