...
public:
	CString  NewTrainNoIsExist(CString trainId, CString& stfindtmrange);
...
public:
	...
	void  CheckTrainManualUpdateOper(CTG_SingleTrain *pnewtrain,const CTG_ScheduleInfo &schd,const CMMIOperFlag &oper_flag, CStringArray& alarmAry);
...
public:
	CString Get_BasicTrainId(TRAIN_INDEX train_index);
	CString Get_ShiftTrainId(TRAIN_INDEX train_index);
