...
public:
	...
	int m_nStplanStationCount;
	int m_nStplanStation[128];
...
public:
	static 	CTgDocument *CreateTgDocument(int section_id);
...
////////////////////////////
	...
	BOOL  InitLogicData(int section_id,CTG_ScheduleInfo::SCHEDULE_TYPE type);
